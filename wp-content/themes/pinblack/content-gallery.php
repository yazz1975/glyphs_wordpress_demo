	...
	<div class="entry-content post_content">
		<?php if ( post_password_required() ) : ?>
			...
			<?php else : ?>
				...
				<p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'pinblack' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'pinblack' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
